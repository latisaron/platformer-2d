...
const IMAGE_WIDTH: f32 = 400.;
const IMAGE_HEIGHT: f32 = 100.;
...
pub fn create_request_button(
    ...
    commands.spawn((
        ...
        Transform::from_xyz(0., -(window_height / 2. - IMAGE_HEIGHT / 2. - PADDING), IMAGE_Z_INDEX),
        RequestReviewButton,
...
pub fn handle_request_review_button_interaction(
    ...
    if keys.just_pressed(MouseButton::Left) {
        if let Some(position) = window.cursor_position() {
            ...
            let button_lwr_x = button_query.translation.x - IMAGE_WIDTH / 2.;
            let button_upr_x = button_query.translation.x + IMAGE_WIDTH / 2.;
            let button_lwr_y = button_query.translation.y - IMAGE_HEIGHT / 2.;
            let button_upr_y = button_query.translation.y + IMAGE_HEIGHT / 2.;
